...
const Page3 = () => {
    return ( 
        <div className="bg-[#F6F5F4] flex-col flex  md:flex-row justify-between items-center h-full py-5" >
            <div className=" px-20 flex flex-col justify-evenly">
            <h1 className="text-black-500 text-2xl md:text-4xl m-8 font-bold font-sans ">INTRODUCTION<br></br>TO HANDY PRINTS</h1>
        <p className="text-gray-600 text-l  ">In a world burdened by academic demands, Handy Prints emerges as a beacon of support</p>

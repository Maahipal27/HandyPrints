...
const Frontt = ({ setIsVisible }) => {
  ...
  return (
    <div className='bg-[#F6F5F4] flex-col flex md:flex-row md:-top-96 justify-between items-center h-full md:h-screen'>
      <div className='md:w-1/2 md:h-full flex flex-col justify-center mb-48 py-1'>
        <h2 className='text-[#2B788B] font-bold text-xl m-3 scroll-pt-60 text-center px-5'>
  ...
  TRY NOW
        ...
        <div className='pr-14 flex flex-row w-full justify-evenly'>
          <button className='text-center cursor-pointer bg-[#C3DCE3] text-[#2B788B] font-sans font-bold w-36  py-2  rounded-full'>
            TRY NOW
          </button>
          <button
            onClick={onClickHandler}
            className='text-center cursor-pointer bg-[#C3DCE3] text-[#2B788B] font-sans font-bold w-36 py-2  rounded-full'
          >
            LEARN MORE
          </button>
        </div>
...
            }} */}
      ...
      <div className='md:h-0 h-96 md:mb-0 mb-10 md:pt-20 items-center justify-center w-1/2 relative'>
        {/* First image */}
        <img
